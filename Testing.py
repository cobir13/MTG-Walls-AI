...
if __name__ == "__main__":
    ...
    for i in range(4):
        game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game._move_zone(game.hand[0], ZONE.FIELD)
    ...
    carygame1._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.FIELD)
    ...
    game.verbose = False
    # field
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.FIELD)
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.FIELD)
    # hand
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.FIELD)
    # hand
    game._move_zone(Cardboard.Cardboard(Decklist2.BreedingPool), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.FIELD)
    # hand
    game._move_zone(Cardboard.Cardboard(Decklist2.HallowedFountain), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    ...
    forest = Cardboard.Cardboard(Decklist2.Forest)
    game._move_zone(forest, ZONE.FIELD)
    assert (game != cp)
    # add a copy of the forst to the other
    forest2 = forest.copy()
    forest2.zone = ZONE.NEW
    cp._move_zone(forest2, ZONE.FIELD)
    assert (
    ...
    game1.verbose = False
    game1._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game1._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.HAND)
    game2 = game1.copy()
    ...
    game1 = GameState.GameState()
    game1.verbose = False
    game1._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    game1._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game2 = game1.copy()
    # game 1: [0] into play, then the other
    game1._move_zone(game1.hand[0], ZONE.FIELD)
    game1.untap_step()
    ...
    game2.verbose = True
    game2._move_zone(Cardboard.Cardboard(Decklist2.HallowedFountain),
                     ZONE.HAND)
    game2._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    ...
    game = GameState.GameState()
    game.verbose = False
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    ...
    game = GameState.GameState()
    game.verbose = False
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.HAND)
    game._move_zone(game.hand[0], ZONE.FIELD)
    ...
    game._move_zone(caryatid, ZONE.FIELD)
    assert (
    ...
    axe = Cardboard.Cardboard(Decklist2.Axebane)
    battle = Cardboard.Cardboard(Decklist2.Battlement)
    game6 = univ2.copy()
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Battlement), ZONE.HAND)
    # deck
    for x in range(10):
        game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.FIELD)
    # hand
    game._move_zone(Cardboard.Cardboard(Decklist2.Blossoms), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Blossoms), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    # deck
    for x in range(10):
        game._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    ...
    # deck
    for x in range(10):
        gameA._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    gameA._move_zone(Cardboard.Cardboard(Decklist2.Arcades), ZONE.FIELD)
    assert (len(gameA.super_stack) == 0)  # Arcades doesn't trigger itself
    # add Blossoms to field and hopefully draw 2
    gameA._move_zone(Cardboard.Cardboard(Decklist2.Blossoms), ZONE.FIELD)
    ...
    gameA._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.FIELD)
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caryatid), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Blossoms), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Arcades), ZONE.HAND)
    # deck
    for x in range(4):
        game._move_zone(Cardboard.Cardboard(Decklist2.Roots), ZONE.DECK)
    for x in range(4):
        game._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    ...
    game.verbose = False
    # deck
    game._move_zone(Cardboard.Cardboard(Decklist2.Plains), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    # hand
    game._move_zone(Cardboard.Cardboard(Decklist2.WindsweptHeath), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.WindsweptHeath), ZONE.HAND)
    ...
    game._move_zone(Cardboard.Cardboard(Decklist2.HallowedFountain), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.TempleGarden), ZONE.DECK)
    ...
    # deck
    for i in range(10):
        gameE._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    # hand
    gameE._move_zone(Cardboard.Cardboard(Decklist2.WindsweptHeath), ZONE.HAND)
    ...
    game = GameState.GameState()
    # deck of 6 cards
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Axebane), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Battlement), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    ...
    for _ in range(6):
        gameF._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    for _ in range(10):
        gameF._move_zone(Cardboard.Cardboard(Decklist2.Island), ZONE.DECK)
    ...
    game1 = GameState.GameState()
    for _ in range(5):
        game1._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    game1._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.DECK)
    for _ in range(10):
    ...
    for _ in range(4):
        game4._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.DECK)
    # should be forests on top
    ...
    game = GameState.GameState()
    game._move_zone(Cardboard.Cardboard(Decklist2.Blossoms), ZONE.DECK)
    game._move_zone(Cardboard.Cardboard(Decklist2.Omens), ZONE.DECK)
    for _ in range(10):
        game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.DECK)
    # put Collected Company directly onto the stack
    game._move_zone(Cardboard.Cardboard(Decklist2.Company), ZONE.STACK)
    ...
    game = GameState.GameState()
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.FIELD)
    game._move_zone(Cardboard.Cardboard(Decklist2.Caretaker), ZONE.FIELD)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.FIELD)
    game._move_zone(Cardboard.Cardboard(Decklist2.Battlement), ZONE.FIELD)
    game._move_zone(Cardboard.Cardboard(Decklist2.Axebane), ZONE.HAND)
    game._move_zone(Cardboard.Cardboard(Decklist2.Forest), ZONE.HAND)
